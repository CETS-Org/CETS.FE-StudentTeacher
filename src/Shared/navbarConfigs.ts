...
export const studentNavbarConfig: NavbarConfig = {
  ...
  userMenuItems: [
    ...
    { 
      ...
      href: "/student/academic-results", 
      icon: Award,
      description: "View your grades and certificates"
    },
    { 
      name: "Attendance", 
  ...
  quickStats: [
    {
      label: "Courses",
      value: "12",
      color: "bg-gradient-to-br from-primary-50 to-accent-50"
    },
    {
      label: "Progress",
      value: "85%",
      color: "bg-gradient-to-br from-success-50 to-warning-50"
    }
  ]
};
