      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <motion.div variants={itemVariants} className="lg:col-span-1">
            <Card className="h-full hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1 border border-gray-200 shadow-md">
              <div className="p-6">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <motion.div variants={itemVariants}>
              <Card className="hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1 border border-gray-200 shadow-md">
                <div className="p-6">
                  <div className="flex items-center gap-4 mb-5">
