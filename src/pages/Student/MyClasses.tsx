...
const mockMyClasses: MyClass[] = [
  {
    ...
    classNum: 1,
    description:
      "Master professional communication skills for the corporate world. Learn presentations, negotiations, and business writing.",
    ...
    nextMeeting: {
      ...
      isActive: true,
      slot: "19:00 - 21:00",
      coveredTopic:"Profession Letter Writting"
    },
  },
  {
    id: "2",
    ...
    classNum: 2,
    description:
      "Comprehensive IELTS preparation covering all four skills: listening, reading, writing, and speaking with practice tests.",
    ...
    // completed class -> không có nextMeeting
  },
  {
    id: "3",
    ...
    classNum: 1,
    description:
      "Practice speaking English in a relaxed, supportive environment with native speakers and fellow learners.",
  ...
  },
  {
    ...
    classNum: 1,
    description:
      "Improve your academic writing skills with focus on essay structure, research techniques, and citation styles.",
  ...
  },
  {
    ...
    classNum: 1,
    description:
      "Perfect your English pronunciation with phonetics, stress patterns, and intonation techniques.",
  ...
  },
  {
    ...
    classNum: 1,
    description:
      "Build a solid foundation in English grammar with clear explanations and practical exercises.",
  ...
  },
  {
    ...
    classNum: 1,
    description:
      "Learn to deliver confident and effective presentations in English for professional settings.",
  ...
  },
  {
    ...
    classNum: 1,
    description:
      "Essential English phrases and vocabulary for traveling confidently in English-speaking countries.",
...
function formatTimeRange(timeSlot: string): string {
  // timeSlot dạng "HH:mm" hoặc "HH:mm - HH:mm", bạn chỉ dùng HH:mm
...
const MyClassCard: React.FC<{ classItem: MyClass }> = ({ classItem }) => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "active":
        return "bg-gradient-to-r from-accent-400 to-accent-500 text-white shadow-lg shadow-accent-500/25";
      case "upcoming":
        return "bg-gradient-to-r from-warning-400 to-warning-500 text-white shadow-lg shadow-warning-500/25";
      default:
      ...
      <div className="p-6 bg-white hover:bg-gradient-to-br hover:from-white hover:to-accent-25/30 transition-all duration-300">
        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3">
              ...
              {/* Status Badge */}
              <span
                className={`inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-full ${getStatusColor(
                  classItem.status
                )}`}
              >
            ...
            <div className="flex items-center gap-2 mb-1">
              <div className="w-8 h-8 bg-accent-400 rounded-full flex items-center justify-center">
                <span className="text-white text-xs font-semibold">
                  {classItem.instructor?.charAt(0) || "T"}
                </span>
              </div>
        ...
        {(() => {
          ...
          const hasValidMeeting =
            nextMeeting &&
            nextMeeting.date &&
            !isNaN(new Date(nextMeeting.date).getTime());

          if (hasValidMeeting) {
            const startDate = new Date(nextMeeting!.date);
            const timeSlot = nextMeeting.slot;
            ...
            return (
              <div className="mb-6">
                <div className="bg-gradient-to-r from-secondary-200 to-secondary-300 border border-accent-200 p-4 rounded-xl">
                  ...
                  {/* Topic (nếu backend sau này có trả về) */}
                  {nextMeeting!.coveredTopic && (
                    <div className="flex items-center gap-2 text-xs text-accent-600 mb-2">
                      <BookOpen className="w-3.5 h-3.5" />
                      <span className="font-medium">
                        Session&apos;s Topic: {nextMeeting!.coveredTopic}
                      </span>
                    </div>
                  )}
                </div>
...
export default function MyClasses() {
  ...
  const tabs = [
    ...
    },
    {
      id: "upcoming",
      label: "Upcoming",
      badge: tabCounts.upcoming,
      color:
        "bg-gradient-to-r from-warning-500 to-warning-600 text-white",
    },
  ];

  const breadcrumbItems = [{ label: "My Classes" }];
