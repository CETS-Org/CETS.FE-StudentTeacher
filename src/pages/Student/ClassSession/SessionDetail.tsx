...
export default function SessionDetail() {
  ...
  return (
      <div className="px-4 py-6 sm:px-6 lg:px-8 space-y-8">
        ...
        >
          <DialogContent size="lg" className="max-h-[75vh] overflow-visible max-w-2xl">
            <DialogHeader>
                          ...
                          {aiScoreData.isAiScore === true && (
                            <div className="bg-warning-50 border-l-4 border-warning-500 p-3 rounded">
                              <p className="text-xs text-warning-800 font-medium leading-relaxed">
                                ⚠️ <strong>Important Note:</strong> This AI-generated score is for reference only and is NOT your final grade. 
                                Your instructor will provide the official grade.
                              </p>
                            </div>
                          )}
                        </div>
